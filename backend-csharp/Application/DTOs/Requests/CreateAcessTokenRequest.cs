...
public record CreateAcessTokenRequest(
    [Required(ErrorMessage = "A acess token is required for acess"),
     ...
     MaxLength(300, ErrorMessage = "Acess token must be at most 300 characters long.")]
    string AcessToken,
    ...
    [Required(ErrorMessage = "A refresh token is required for person"),
     ...
     MaxLength(300, ErrorMessage = "Refresh token must be at most 300 characters long.")]
    string RefreshToken
);
