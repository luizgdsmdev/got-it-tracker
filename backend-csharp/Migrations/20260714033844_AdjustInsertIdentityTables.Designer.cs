...
namespace backend_csharp.Migrations
{
    ...
    [Migration("20260714033844_AdjustInsertIdentityTables")]
    partial class AdjustInsertIdentityTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_csharp.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("backend_csharp.Domain.Entities.ApplicationUser", null)
                        .WithMany()
